<template>
  <main class="main skeleton-body">
    ...
    <div class="container">
      <div class="product-single-container product-both-info" v-if="product">
    ...
    <div
      class="product-single-tabs custom-product-single-tabs pt-2 mb-0 mt-6 pb-3"
    >
      <div class="container">
        ...
        <pv-desc-one :product="product" v-else></pv-desc-one>
      </div>
    </div>
