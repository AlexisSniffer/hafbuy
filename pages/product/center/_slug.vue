<template>
  <main class="main skeleton-body">
    ...
    <div class="container">
      ...
      >
        <div class="row">
          <div class="col-lg-3 order-1 order-lg-0" sticky-container>
            <div
          ...
          <div class="col-lg-3 order-2 order-lg-0" sticky-container>
            <div
    ...
    <div class="container mb-4" v-if="!product">
      <div class="skel-group skel-center">
        ...
        <div
          class="summary-before col-lg-6 overflow-hidden order-0 order-lg-0"
        ></div>
        <div class="summary entry-summary col-lg-3 order-2 order-lg-0"></div>
      </div>
    </div>

    <pv-desc-three :product="product" v-else></pv-desc-three>

    <div class="container">
      <div class="skel-group mb-4" v-if="!product">
