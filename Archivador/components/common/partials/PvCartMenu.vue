      ...
      <div class="dropdownmenu-wrapper custom-scrollbar">
        ...
        <template v-if="cartList.length > 0">
            ...
            >
              <div class="product-details">
                <h4 class="product-title">
                  <nuxt-link
                    ...
                    >{{ product.attributes.name }}</nuxt-link
                  >
                </h4>
              ...
              <figure class="product-image-container">
                ...
                <a
                  ...
                  @click="removeCart(product.attributes.name)"
                >
                  <span>×</span>
                </a>
              </figure>
          ...
          <div class="dropdown-cart-action">
            <nuxt-link to="/pages/cart" class="btn btn-gray btn-block view-cart"
              >View Cart</nuxt-link
            >
            <nuxt-link to="/pages/checkout" class="btn btn-dark btn-block"
              >Checkout</nuxt-link
            >
          </div>
        </template>
