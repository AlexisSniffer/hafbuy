<template>
  <div>
    <h1 class="product-title">{{ product.attributes.name }}</h1>
    ...
    <div class="ratings-container">
      <div class="product-ratings">
        ...
        <span class="tooltiptext tooltip-top">{{
          product.attributes.ratings | priceFormat
        }}</span>
      </div>
      <a
        href="javascript:;"
        class="rating-link"
        v-if="product.attributes.reviews > 0"
        >( {{ product.attributes.reviews }} Reviews )</a
      >
    ...
    <div class="product-desc" v-if="product.attributes.description">
    ...
    <ul class="single-info-list">
      ...
      <li>
        ...
        <strong>
          <nuxt-link
            ...
            v-for="(item, index) in product.attributes.categories.data"
      ...
      <!-- TODO: añadir esquema de tags en strapi -->
