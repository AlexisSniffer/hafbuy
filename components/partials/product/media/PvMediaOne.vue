  ...
  <div>
    <div class="product-slider-container">
      ...
      >
        <div
          class="swiper-slide"
          v-for="item in product.attributes.images.data"
          :key="item.name"
        >
          <img
    ...
    <!-- <light-box :media="lightBoxMedia" :show-light-box="false" /> -->
    <!-- <LightBox
      ref="lightBox"
      :media="lightBoxMedia"
      :showLightBox="false"
...
export default {
  ...
  computed: {
    //TODO: corregir lightboxmedia
    lightBoxMedia: function () {
      return this.product.attributes.images.data.reduce((acc, cur) => {
        return [
          ...acc,
          {
            src: `${baseUrl}${cur.attributes.url}`,
            thumb: `${baseUrl}${cur.attributes.url}`,
          },
        ]
      }, [])
    },
