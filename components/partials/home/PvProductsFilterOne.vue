          ...
          <div class="col-lg-3 pr-lg-3 pr-sm-0 col-sm-6 order-1 order-sm-0">
            <div class="shop-list h-100">
              ...
              <ul class="nav nav-tabs flex-sm-column border-0" role="tablist">
                ...
                >
                  <a href="javascript:;" class="nav-link">Casual Shoes</a>
                </li>
                ...
                >
                  <a href="javascript:;" class="nav-link">Spring & Autumn</a>
                </li>
                ...
                <li
                  ...
                  data-category="man"
                >
                  <a href="javascript:;" class="nav-link">Man</a>
                </li>
                ...
                >
                  <a href="javascript:;" class="nav-link">Accessories</a>
                </li>
                ...
                >
                  <a href="javascript:;" class="nav-link">Pants & Denim</a>
                </li>
                ...
                >
                  <a href="javascript:;" class="nav-link">Watch Fashion</a>
                </li>
                ...
                <li
                  ...
                  data-category="woman"
                >
                  <a href="javascript:;" class="nav-link">Woman</a>
                </li>
                ...
                >
                  <a href="javascript:;" class="nav-link">Dresses & Skirts</a>
                </li>
                ...
                >
                  <a href="javascript:;" class="nav-link">Shoes & Boots</a>
                </li>
                ...
                >
                  <a href="javascript:;" class="nav-link">Top & Blouses</a>
                </li>
              </ul>
