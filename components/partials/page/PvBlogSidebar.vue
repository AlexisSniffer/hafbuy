<template>
  <aside class="sidebar blog-sidebar mobile-sidebar col-lg-3" sticky-container>
    <div class="sidebar-content skeleton-body" v-if="!loaded">
      ...
      <div class="sidebar-wrapper">
        <div class="sidebar-content">
          <div class="widget widget-categories">
            ...
            <ul class="list">
              <li v-for="(cat, index) in blogCategoryList" :key="index">
                <nuxt-link
                  :to="{ path: '/pages/blog', query: { category: cat.slug } }"
                  >{{ cat.Name }}</nuxt-link
                >
              </li>
            </ul>
          ...
          <div class="widget widget-post" v-if="recentPosts.length > 0">
