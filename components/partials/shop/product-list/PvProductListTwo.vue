  ...
  <div>
    <nav class="toolbox sticky-header horizontal-filter filter-sorts">
      ...
      <div class="toolbox-item toolbox-sort select-custom">
        ...
        <div class="select-custom">
          <select
            ...
            @change="getProducts"
          >
            <option value="default" selected="default">Default sorting</option>
      ...
      <div class="toolbox-item layout-modes">
        <a href="javascript:;" class="layout-btn btn-grid active" title="Grid">
          <i class="icon-mode-grid"></i>
        </a>
        <nuxt-link to="/shop/list" class="layout-btn btn-list" title="List">
