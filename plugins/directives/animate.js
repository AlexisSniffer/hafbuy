...
function addCss(item) {
  if (item.getAttribute('data-animation-delay'))
    delay = parseInt(item.getAttribute('data-animation-delay'))
  if (item.getAttribute('data-animation-duration'))
    duration = parseInt(item.getAttribute('data-animation-duration'))
  if (item.getAttribute('data-animation-name'))
    keyframes = item.getAttribute('data-animation-name')
